<?php $title = 'Contact Us'; // In this line I am defining the Title of the page which works with the design of the header.html?>
...
if(isset($_POST['email'])) {
  ...
  if(strlen($comments) < 2) {
    ...
    $error_message .= '<span style="color:red">The Comments you entered do not appear to be valid.<br /></span>';
...
<form name="contactform" method="post" action="contact_us.php" class="basic-grey" >
 
 <h1>Contact Us <span><?php if ($_SERVER['REQUEST_METHOD']=='POST'){
 ...
 {
	echo "Feel free to contact us anything.";
 }?></span>
    </h1>
  ...
  <input  type="text" name="telephone" maxlength="30" size="30" style="width: 90%;">

  <label for="comments">Comments *</label>
  <textarea  name="comments" maxlength="1000" cols="25" rows="6" style="width: 90%;"></textarea>
